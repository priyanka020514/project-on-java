...
public class Verify_Preconditions {
	...
	public static void main(String[] args) throws Exception {
       ...
       System.out.println("Dropdown Multiple Selection State is---->"+flag);
		...
		int Selectioncount = dropdown.getAllSelectedOptions().size();
		      if(Selectioncount > 1)
		      { 
		    	  System.out.println("Precondition testcase Pass:User can use multiple option");
		      
		          if(Selectioncount < 4)
		          {
		        	  System.out.println("Test case Pass:User is able to select three state value from drop down list");
		          ...
		          {
		        	  System.out.println("Test case Fail:Limit ecxeeded greater then three");
		          }
		      }
		   else
		      {
		    	  System.out.println("Precontion testcase fail:User can't use multiple option");
